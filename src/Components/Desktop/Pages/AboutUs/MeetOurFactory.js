  ...
  return (
    ...
    <Slider  className="slidermeetourfactory" ref={slider} {...settings4}>
         <div>
          ...
          <img className="w-100" src="./assets/images/AboutPage/meetourfactory1.png" alt="" />
         </div>
         <div>

          <img className="w-100" src="./assets/images/AboutPage/meetourfactory2.png" alt="" />
         </div>
         <div>
          <img className="w-100" src="./assets/images/AboutPage/meetourfactory3.png" alt="" />
