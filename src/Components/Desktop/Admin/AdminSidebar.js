          ...
          <ul>
            ...
            <li className={`drp ${isJobEntryOpen ? "open" : ""}`}>
              <div className="front" onClick={toggleJobEntry}>
                <Link>Home page</Link>
                <img
                  style={isJobEntryOpen ? { transform: "rotate(180deg)" } : {}}
              ...
              <ul className="sub-list">
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/introcomp`
                        ? "active"
                        : ""
                    }
                  >
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == "/dashboard/industrycards"
                        ? "active"
                        : ""
                    }
                  >
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/product-line`
                        ? "active"
                        : ""
                    }
                  >
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/partner-brands`
                        ? "active"
                        : ""
                    }
                  >
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/whyferrytech`
                        ? "active"
                        : ""
                    }
                  >
              ...
              <ul className="sub-list">
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/productpage`
                        ? "active"
                        : ""
                    }
                  >
              ...
              <ul className="sub-list">
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/servicemaintext`
                        ? "active"
                        : ""
                    }
                  >
                ...
                <li>
                  <Link
                    ...
                    className={
                      location.pathname == `/dashboard/servicepage`
                        ? "active"
                        : ""
                    }
                  >
